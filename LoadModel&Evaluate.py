...
# montage = build_montages(results, (128, 128), (8, 8))[0]
...
for i,pred in enumerate(arrayOfPreds):
	if arrayOfPreds[i] == 1:
		count += 1

percentage = count/len(arrayOfPreds) 

print("ACERTOS: '{}', Tamanho da amostra: '{}'".format(percentage,len(arrayOfPreds)))